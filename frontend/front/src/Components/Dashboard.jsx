    ...
    return (
        <main>
            <div className="flex flex-col md:flex-row h-screen">
               <div className='bg-yellow-400 w-80 h-screen'>
                <div className='grid grid-cols-1 font-semibold text-xl'>
                <button className='bg-yellow-500 h-12  border-b border-yellow-900'>See Statistics</button>
                <button className=' h-12  border-b border-yellow-900'>See Announces</button>
                <button className=' h-12  border-b border-yellow-900'>See Accounts</button>
                </div>
