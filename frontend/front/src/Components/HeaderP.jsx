...
function HeaderP() {
 const storedData = localStorage.getItem("user");
  ...
  return (
    <div className="flex justify-between border shadow-lg pt-4 pb-2 relative">
        ...
        <form action="/search" className="max-w-[480px] w-full px-4">
          <div className="relative">
            <input
              type="text"
              name="q"
              className="w-full border h-8 shadow p-4 rounded-full"
              placeholder="search"
            />
            <button type="submit">
              <svg
                className="text-yellow-400 h-5 w-5 absolute top-2 right-3 fill-current"
      ...
      {showPopup && (
        <>
          ...
          >
            <div className="relative p-4 w-full max-w-2xl max-h-full top-16 left-80">
  ...
  <div className="grid grid-rows-2 gap-2">
    <input type="file" className="text-white bg-yellow-300 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800" placeholder="add images"/>
