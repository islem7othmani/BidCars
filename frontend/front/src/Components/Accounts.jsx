...
<div class="w-full flex justify-center relative top-6">

	<div class="p-4 w-3/4  bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
            <li class="py-3 sm:py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="bg-red-600 text-white rounded-full py-2 px-4 inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                        Delete Account
                    </div>
                    </div>
                </div>
