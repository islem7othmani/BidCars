...
const Products = () => {
  ...
  return (
    ...
    <div className='' data-aos="fade-up" id='products'>
...
<div key={product.id} class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center mt-2.5 mb-5">
            ...
            <span class="bg-yellow-300 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">5.0</span>
        </div>
        <div class="flex items-center justify-between">
            
            <a href="#" class="text-black bg-yellow-300 hover:bg-yellow-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View Details</a>
        </div>
    </div>
</div>
      ...
      {visibleProducts.length < products.length && (
        <div className="flex justify-center mt-4">
          <button
            ...
            className="mx-2 mt-8 px-4 py-2 bg-yellow-300 text-black rounded"
          >
            Show More Products
          </button>
        </div>
